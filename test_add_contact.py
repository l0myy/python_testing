...
class AddTestGroup(unittest.TestCase):
    ...
    def test_add_test_group(self):
        ...
        self.create_contact(wd, Contact(firstname="Anatolii", middlename="Vladimirovich", lastname="Trofimov",
                                        nickname="l0my", title="titles", company="bercut", address="saint-petersburg",
                                        home="sweet home", mobile="85945739", work="32302", fax="445566", email="wprwrew@mail.ru",
